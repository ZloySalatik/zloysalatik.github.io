...
pogradient.set();function postars(canvas) {
    var _this = this,
    ...
    Star.prototype = {
        create: function() {
            ...
            ctx.fillStyle = _this.config.star.color.replace(/,s*0.8s*\)/, ', ' + this.opacity + ')');
            ctx.shadowBlur = _this.config.star.glowBlur;
            ctx.shadowColor = _this.config.star.glowColor;
            ctx.fill();
        },
        animate: function() {
    ...
    _this.createInitialStars = function() {
        var length = _this.config.length,
            i;
        for (i = 0; i < length; i++) {
